...
for month in range(9, 10):
    ...
    nemlite_results = pd.read_csv('E:/anvil_data/no_fs_checks_results_2_{}_{}.csv'.format(year, str(month).zfill(2)))
    ...
    db.construct_pdf(nemlite_results, actual_prices,
                     'E:/anvil_data/no_fs_checks_results_2_{}_{}.pdf'.format(year, str(month).zfill(2)))
