...
for month in range(1, 2):
    ...
    nemlite_results = pd.read_csv('E:/nemlite_journal_results/base_line_{}_{}.csv'.format(year, str(month).zfill(2)))
    ...
    db.construct_pdf(nemlite_results, actual_prices,
                     'E:/nemlite_journal_results/base_line_{}_{}.pdf'.format(year, str(month).zfill(2)))
